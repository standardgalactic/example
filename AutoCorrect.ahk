...
!a::Run, notepad.exe "C:\Users\Mechachleopteryx\OneDrive\Desktop\Blank\Examples\AutoCorrect.ahk" ; press Alt+a to open this file.
...
::legn::length
::leng::length
::lth::length   ;; el-th, "lth", not one-th "1th"
::len::length   ;; turn this off if programming in a language other than Haskell
                ;; hey that just reminded me of something I wanted to do:
                ;;
::get put string::getPutStr
::get putter::getPutStr
::get putstr::getPutStr
::get ptstr::getPutStr
::getputstr::getPutString
::print string::getPutStr
                ;;
                ;;
::let;s::let's
::leathal::lethal
...
;-------------------------------------------------------------------------------
; Anything below this point was added to the script by the user via the Win+H hotkey. (actually, if invoked by another script such as PrintScreen, it will be added to the bottom of that script. Notepad doesn't show that the script has been updated. You could move it back here later, if you wanted to.
;-------------------------------------------------------------------------------
