...
\textit{Section 18.} \textit{\textbf{Expanding Memory Strategies}: editor/tmux ecologies (vim/byobu), reversible erasure, literate ops.}\index{expanding memory}

\textit{Section 19.} \textit{\textbf{Procedural Hermeneutics}: comments, whitespace, and the ethics of attention as ontic operators.}\index{hermeneutics}
